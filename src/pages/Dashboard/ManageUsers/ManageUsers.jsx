...
const ManageUsers = () => {
  ...
  const handleMakeAdmin = (user) => {
    fetch(`https://academy-camp.vercel.app/users/admin/${user._id}`, {
      method: "PATCH",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleMakeInstructors = (user) => {
    fetch(
      `https://academy-camp.vercel.app/users/instructors/${user._id}`,
      {
        method: "PATCH",
      }
    )
  ...
  const handleDelete = (user) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://academy-camp.vercel.app/users/${user._id}`, {
          method: "DELETE",
        })
          .then((res) => res.json())
          .then((data) => {
