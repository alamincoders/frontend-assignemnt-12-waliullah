...
const Classes = () => {
  ...
  const handleAddToClass = (item) => {
    ...
    if (user && user?.email) {
      ...
      fetch("https://academy-camp.vercel.app/addToClass", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="py-5">
      {/* <div
        className="hero bg-right-top h-96"
        style={{
          backgroundImage: `url("https://i.ibb.co/47tRSdY/image.png")`,
        }}
      >
      ...
      <h3 className="text-4xl font-semibold text-center pt-5 my-6 border-b-4 border-slate-300 mx-auto pb-3 w-[380px]">There are all Classes</h3>
